<head>
<link rel="stylesheet" type="text/css" href="http://localhost/code-igniter/assets/css/stylebuku.css">
<section>
    ...
    atas dapat di simpulkan bahwa controller sebagai penghubung view dan model.
    Misalnya pada aplikasi yang menampilkan data dengan menggunakan metode konsep mvc,
    controller memanggil intruksi pada model yang mengambil data pada database, kemudian
    controller yang meneruskannya pada view untuk di tampilkan. Jadi jelas sudah dan sangat
    mudah dalam pengembangan aplikasi dengan cara mvc ini karena web designer atau front-end
    ...
    aplikasi dapat di lakukan dengan cepat dan terstruktur.</p> </section>